              ...
              switch (elt.id) {
                case 'l15':
                  ...
                  if (palavraNaLista(palavraInputada)) {
                    ...
                    if (palavraInputada == palavraTemp) {
                      // acertou a palavra
                      document.write("Barbaridade! Em cima do laço! Acertaste a palavra "+palavraTemp);
                    } else {
                      // verificar as letras
                ...
                case 'l65':
                  ...
                  if (palavraNaLista(palavraInputada)) {
                    ...
                    document.write("Bah, me caiu os butiá do bolso! Tchê, a palavra era "+palavraTemp);                
                  } else {
...
function limpaTodasAsPalavras() {
  letra11Display.innerText = '_';
  letra12Display.innerText = '_';
  letra13Display.innerText = '_';
  letra14Display.innerText = '_';
  letra15Display.innerText = '_';
}
